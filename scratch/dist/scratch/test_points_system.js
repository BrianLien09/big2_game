...
// Mock player creator
function makePlayer(uid, cardCount, points = 0, isBot = false) {
...
function runTests() {
    ...
    // Step 1.1: A 出完手牌
    (0, roomService_1.commitPlayerPlayTx)(room, "A", [room.players.A.cards[0]]);
    ...
    (0, roomService_1.commitPlayerPlayTx)(updatedRoom, "B", [updatedRoom.players.B.cards[0]]);
    ...
    (0, roomService_1.commitPlayerPlayTx)(updatedRoom, "C", [updatedRoom.players.C.cards[0]]);
    ...
    (0, roomService_1.commitPlayerPlayTx)(room3, "A", [room3.players.A.cards[0]]);
    let updatedRoom3 = room3;
    (0, roomService_1.commitPlayerPlayTx)(updatedRoom3, "B", [updatedRoom3.players.B.cards[0]]);
    ...
    (0, roomService_1.commitPlayerPlayTx)(room2, "A", [room2.players.A.cards[0]]);
    ...
    (0, roomService_1.commitPlayerPassTx)(passRoom, "B");
    ...
    (0, roomService_1.commitPlayerPassTx)(updatedPassRoom, "C");
    ...
    // B Pass
    (0, roomService_1.commitPlayerPassTx)(passRoom2, "B");
    ...
    (0, roomService_1.commitPlayerPassTx)(updatedPassRoom2, "C");
    ...
    // C 出完手牌，觸發結算
    (0, roomService_1.commitPlayerPlayTx)(exitRoom, "C", [exitRoom.players.C.cards[0]]);
