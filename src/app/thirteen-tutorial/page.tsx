  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      <Section title="什麼是十三支？" emoji="🥞">
        ...
        <p style={pStyle}>
          不同於大老二需要輪流出牌，十三支是<strong>「不打牌、不叫牌」</strong>的。玩家排出心目中的最佳分墩組合後，直接以「翻牌」的方式與其他玩家兩兩進行三墩的比拼，結算輸贏。
        </p>
      </Section>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      <Section title="點數大小（正規順序）" emoji="🔢">
        ...
        <InfoBox type="tip">
          <strong>點數注意！</strong>十三支的點數順序是<strong>A 最大、2 最小</strong>。這與大老二（2 最大、3 最小）完全相反，排牌時請千萬注意！
        </InfoBox>
      </Section>
