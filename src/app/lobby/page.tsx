...
export default function Lobby() {
  ...
  return (
    ...
    <main className="page-shell flex flex-col items-center justify-center min-h-screen p-4 relative bg-[#f8f9fa]" style={{
      ...
      <div className="lobby-profile absolute top-4 right-0 flex items-center" style={{ gap: "12px", marginRight: "24px" }}>
      ...
      <div className="text-center z-10 mb-12">
        <h1 className="lobby-heading text-6xl md:text-8xl font-black tracking-tight mb-4" style={{ fontFamily: "var(--font-display)" }}>
          Card<span className="text-[#dc2626]">Duel</span>
        </h1>
        <p className="lobby-subtitle text-sm md:text-base font-bold tracking-widest text-gray-600" style={{ marginBottom: "40px" }}>
          🃏 大老二  ·  🃍 十三支  ·  💔 傷心小棧  ·  即時多人對戰
        </p>
        ...
        <div className="lobby-actions flex flex-col sm:flex-row justify-center items-center" style={{ gap: "20px", marginTop: "16px" }}>
          <button 
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -z-10 w-full max-w-2xl h-64 pointer-events-none opacity-20 md:opacity-40">
        <div className="floating-card card card-medium absolute top-0 left-[20%] transform -rotate-12">
          <div className="card-content">
            <div className="card-value">2</div>
            <div className="card-suit text-red-500">♥</div>
          </div>
        </div>
        <div className="floating-card floating-card--right floating-card--late card card-medium absolute top-4 right-[20%] transform rotate-12">
          <div className="card-content">
